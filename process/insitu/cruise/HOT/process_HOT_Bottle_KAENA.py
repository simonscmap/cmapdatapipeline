...
df['lat']=21.847
df['lon']=-158.363
df['depth']=df['pressure_ctd_bottle_kaena_hot']
...
shutil.copy(script_path + 'process/insitu/cruise/HOT/process_process_HOT_Bottle_KAENA.py', code_folder + 'process_HOT_Bottle_KAENA.py')
