...
df['lat']= 22.67
df['lon']= -157.95
df['depth']=df['pressure_ctd_bottle_whots52_hot']
...
shutil.copy(script_path + 'cmapdata/process/insitu/cruise/HOT/process_HOT_Bottle_WHOTS52.py', code_folder + 'process_HOT_Bottle_WHOTS52.py')
