...
tbl = 'tblGeotraces_Precipitation'
n = f'{vs.cruise}{tbl}/raw/GEOTRACES_IDP2021_Precipitation_Data_v1.nc' 
...
df_varnames.to_excel(vs.download_transfer +'Geotraces_Precipitation_Variables.xlsx', index=False)
