...
def getHOT268_navigation():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  https://www.nodc.noaa.gov/archive/arc0128/0182287/1.1/data/0-data/KM1427_603562_r2rnav/data/KM1427_bestres.geoCSV"
    )
    os.system(wget_str)
...
def getHOT268_adcp():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  http://get.rvdata.us/cruise/KM1427/fileset/115308"
    )
...
def getHOT268_barometer():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  http://get.rvdata.us/cruise/KM1427/fileset/115940"
    )
...
def getHOT268_tsv():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  http://get.rvdata.us/cruise/KM1427/fileset/116039"
    )
    os.system(wget_str)  # downloads data
...
def getHOT268_met():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  http://get.rvdata.us/cruise/KM1427/fileset/116080"
    )
    os.system(wget_str)  # downloads data
