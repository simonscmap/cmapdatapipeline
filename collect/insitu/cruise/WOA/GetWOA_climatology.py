...
def getWOA_data():
    for variable in variable_list:
        ...
        if (
            ...
            or variable == "density"
            or variable == "salinity"
            or variable == "sea_water_electrical_conductivity"
            or variable == "sea_water_sigma"
            or variable == "sea_water_temperature"
            or variable == "temperature"
        ):
            print("collecting 1.00 degree data for " + variable)
            wget_str = (
                "wget -N -nH -nd -r -e robots=off --no-parent --force-html -A.nc http://data.nodc.noaa.gov/woa/WOA13/DATAv2/"
                + variable
                + "/netcdf/decav/"
                + spatial_res
                + "/ "
