...
def get_nrt_avhrr_oi(yr, mn, dy):
    ...
    url = (
        "ftp://podaac-ftp.jpl.nasa.gov/allData/ghrsst/data/GDS2/L4/GLOB/NCEI/AVHRR_OI/v2/%s/%s/%s120000-NCEI-L4_GHRSST-SSTblend-AVHRR_OI-GLOB-v02.0-fv02.0.nc"
        % (yr, dayn, stamp)
    )
    ...
    print(
        "Dowloading AVHRR_OI_SST >>>  date: %s,  DayNumber: %s"
