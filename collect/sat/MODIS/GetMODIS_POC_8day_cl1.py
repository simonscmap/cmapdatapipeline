...
start_date = dt.date(2003, 12, 27)
start_date = dt.date(2002, 7, 4)
end_date = dt.date.today()
end_date = dt.date(2003, 1, 8)
delta = dt.timedelta(days=8)

def get_POC(start_date,base_folder,retry=False):
...
while start_date <= end_date:
    get_POC(start_date,base_folder)
