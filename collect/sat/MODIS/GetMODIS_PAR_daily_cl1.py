...
def get_PAR(start_date,retry=False):
    ...
    file_url = f"https://oceandata.sci.gsfc.nasa.gov/cgi/getfile/AQUA_MODIS.{start_index}.L3m.DAY.PAR.par.9km.nc"
    Original_Name =f"AQUA_MODIS.{start_index}.L3m.DAY.PAR.par.9km.nc"
    ...
    if not downloaded:
        ...
        print("Already downloaded: " +  start_index )

while start_date <= end_date:
    get_PAR(start_date,base_folder,True)
    start_date = start_date + delta

## Started 4/18 11:25am - 12:06am

metadata.export_script_to_vault(tbl,'satellite','collect/sat/MODIS/GetMODIS_PAR_cl1.py','collect.txt')       
