...
#https://oceandata.sci.gsfc.nasa.gov/cgi/getfile/AQUA_MODIS.20230101_20230108.L3m.8D.POC.poc.9km.NRT.nc
...
def get_POC(start_date,retry=False):
    ...
    file_url = f"https://oceandata.sci.gsfc.nasa.gov/cgi/getfile/AQUA_MODIS.{start_index}_{end_index}.L3m.8D.POC.poc.9km.NRT.nc"
    Original_Name = f"AQUA_MODIS.{start_index}_{end_index}.L3m.8D.POC.poc.9km.NRT.nc"
